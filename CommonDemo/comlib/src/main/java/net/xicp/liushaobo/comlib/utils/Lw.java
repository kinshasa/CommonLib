...
public class Lw 
{
	private static String TAG = "v1512211";
    private static Context ctx;
    // 日志类型标识符(优先级：由低到高排列，取值越小优先级越高)
    public static final char SHOW_VERBOSE_LOG = 0x01;//0000 0001
    public static final char SHOW_DEBUG_LOG   = 0x02;//0000 0010	0x01 << 1
    public static final char SHOW_INFO_LOG    = 0x04;//0000 0100	0x01 << 2
    public static final char SHOW_WARN_LOG    = 0x08;//0000 1000	0x01 << 3
    public static final char SHOW_ERROR_LOG   = 0x16;//0001 0000	0x01 << 4
    public static final char SHOW_NONE_LOG	  = 0x32;//0000 0000
...
//                                            SHOW_ERROR_LOG;
    ...
    public static String m_strLogName = "custom.txt";
    // 得到当前日期时间的指定格式字符串
    private static SimpleDateFormat m_sdfFileName = new SimpleDateFormat("yyyyMMddHH");// 日志名称格式
    public  static String m_strDateTimeFileName = m_sdfFileName.format( new Date() );
	...
	public static String getDefaultTag(StackTraceElement stackTraceElement) {
		...
		//logInfoStringBuilder.append(APPNAME).append(POINT);
