...
public class L {
	...
	public static int LEVEL_PRINTF = VERBOSE;//<LEVEL_PRINTF,打印Log等级
	public static int LEVEL_WRITE = VERBOSE;//>LEVEL_WRITE,写入Log文件等级
    public static String APPNAME = "[iCar]";
    
    public static final String SEPARATOR = " ";
    
    public static void init() {
		// TODO Auto-generated constructor stub
    	LEVEL_PRINTF = VERBOSE;
    	LEVEL_WRITE = VERBOSE;
    	APPNAME = "[iCar]";
	}
	 ...
	 * 则TAG为MainActivity
	 */
	public static String getDefaultTag2(StackTraceElement stackTraceElement) {
