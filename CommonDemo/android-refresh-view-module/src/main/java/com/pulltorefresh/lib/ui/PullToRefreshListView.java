package com.pulltorefresh.lib.ui;
...
import com.pulltorefresh.lib.ui.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    /* (non-Javadoc)
     * @see com.lee.pullrefresh.ui.PullToRefreshBase#createRefreshableView(android.content.Context, android.util.AttributeSet)
     */
    @Override
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        Log.v("liushaobo2005@163.com", "PullToRefreshListView setScrollLoadEnabled()");
        if (scrollLoadEnabled) {
            // 设置Footer
            if (null == mLoadMoreFooterLayout) {
                mLoadMoreFooterLayout = new FooterLoadingLayout(getContext());//getFooterLoadingLayout()
            }
            
            //addFooterView会导致数据少时显示不到最低端问题@liushaobo2005@163.com
            if (null == mLoadMoreFooterLayout.getParent()) {
               mListView.addFooterView(mLoadMoreFooterLayout, null, false);
            }
            //addView(mLoadMoreFooterLayout);
    ...
    public LoadingLayout getFooterLoadingLayout() {
    	...
    	//设置父类的foot@liushaobo2005@163.com
    ...
    protected LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
    	...
    	//重写了下拉刷新布局@liushaobo2005@163.com
