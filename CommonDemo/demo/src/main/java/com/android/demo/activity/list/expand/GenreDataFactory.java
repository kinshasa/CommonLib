...
public class GenreDataFactory {
  ...
  public static Genre makeRockGenre() {
    return new Genre("Rock", makeRockArtists(), R.drawable.icon_delete);
  }
  ...
  public static Genre makeJazzGenre() {
    return new Genre("Jazz", makeJazzArtists(), R.drawable.icon_delete);
  }
  ...
  public static Genre makeClassicGenre() {
    return new Genre("Classic", makeClassicArtists(), R.drawable.icon_delete);
  }
  ...
  public static Genre makeSalsaGenre() {
    return new Genre("Salsa", makeSalsaArtists(), R.drawable.icon_delete);
  }
  ...
  public static Genre makeBluegrassGenre() {
    return new Genre("Bluegrass", makeBluegrassArtists(), R.drawable.icon_delete);
  }
